            ...
            <div className="overflow-x-auto">
              ...
              {filtered.length === 0 && (
                ...
                >
                  ...
                  <Link href="/enquiry" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-primary text-white text-sm font-bold hover:bg-primary-dark transition-colors">
