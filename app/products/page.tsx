        ...
        <div className="container-wide">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {categories.map((cat, i) => {
              const color = tagColors[cat.tag] ?? '#243774'
              return (
                <motion.div
                  key={cat.title}
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-sm text-cyan font-semibold mb-4">{cat.count} products</p>
          ...
          >
            ...
            <Link
              href="/enquiry"
              className="flex-shrink-0 inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-cta text-white text-sm font-bold hover:bg-cta-dark active:scale-95 transition-all duration-150"
            >
